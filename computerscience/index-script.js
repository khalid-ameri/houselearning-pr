document.addEventListener('DOMContentLoaded', () => {
  ...
  const programmingLanguages = {
    ...
    'python': ['python-intro.html', 'python-syntax.html', 'python-variables.html', 'python-loops.html', 'python-functions.html'],
    'java': ['java-intro.html', 'java-data-types.html', 'java-control-flow.html', 'java-arrays.html'],
    'js': ['introtojs.html', 'variabletypes.html', 'function.html', 'eventlisteners.html', 'dom.html', 'conditions.html'],
    ...
    'typescript': ['typescript-intro.html', 'typescript-data-types.html', 'typescript-interfaces.html'],
